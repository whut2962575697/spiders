...
class HuiCongSpider(object):
    ...
    def spider(self):
        ...
        next_url = self.base_url % (self.keyword,i)
        while True:
                company_list, next_url = self.download_list_urls(next_url, r'<a data-exposurelog="\w+" href="(http://\w+.b2b.hc360.com/)" onclick'
                                                                 )
